...
<head>
    ...
    <title>{{ config('app.name') }} Account Confirmation</title>
</head>
<body>
                                    ...
                                    <tbody>
                                        <tr style="vertical-align:top;padding:0">
                                            <td style="vertical-align:top;text-align:left;padding:0" align="left" valign="top">
                                                <h1 style="color:#f60066;display:block;font-family:hybrea,proxima-nova,'helvetica neue',helvetica,arial,geneva,sans-serif;font-size:32px;font-weight:200;text-align:left;margin:0 0 40px" align="left"><img src="http://comicats.herokuapp.com/images/logo.png" alt="comicats" width="200" height="auto" style="outline:none;text-decoration:none;border:0"></h1>

                                                <p style="margin:20px 0">Thanks for signing up with {{ config('app.name') }}! Follow this link to activate your account:</p>

                                                <p style="margin:20px 0"><a href="{{$link}}" style="color:#f60066" target="_blank">{{$link}}</a>

                                                </p><p style="margin:20px 0">Have fun, and don't hesitate to contact us with your feedback.</p>

                                                <p style="margin:20px 0">
                                                    {{ config('app.name') }} Team<br>
                                                    <a href="https://comicats.heroku.com" style="color:#f60066" target="_blank" >https://comicats.com</a>
                                                </p>
                                                <p></p>
                                            </td>
                                        </tr>
