<a href="#" id="remove-subscription" class="button button_theme_white-light button_size_l">
    ...
    <svg class="button__i-subscribe"><use xlink:href="/images/icon.svg#icon_close"></use></svg>
    <span class="button__text">Unsubscribe</span>
</a>