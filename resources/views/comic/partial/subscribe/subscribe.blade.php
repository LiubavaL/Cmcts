<a href="#" id="add-subscription" class="button button_theme_white-light button_size_l">
    ...
    <svg class="button__i-subscribe"><use xlink:href="/images/icon.svg#icon_favorites"></use></svg>
    <span>Subscribe</span>
</a>